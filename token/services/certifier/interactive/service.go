...
//go:generate counterfeiter -o mock/backend.go -fake-name Backend . Backend
type Backend interface {
	Load(context view.Context, cr *CertificationRequest) ([][]byte, error)
}

//go:generate counterfeiter -o mock/responder_registry.go -fake-name ResponderRegistry . ResponderRegistry
