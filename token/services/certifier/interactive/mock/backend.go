...
func (fake *Backend) Load(arg1 view.Context, arg2 *interactive.CertificationRequest) ([][]byte, error) {
	fake.loadMutex.Lock()
...
func (fake *Backend) LoadCallCount() int {
	fake.loadMutex.RLock()
	defer fake.loadMutex.RUnlock()
	return len(fake.loadArgsForCall)
}

func (fake *Backend) LoadCalls(stub func(view.Context, *interactive.CertificationRequest) ([][]byte, error)) {
	fake.loadMutex.Lock()
	defer fake.loadMutex.Unlock()
	fake.LoadStub = stub
}

func (fake *Backend) LoadArgsForCall(i int) (view.Context, *interactive.CertificationRequest) {
	fake.loadMutex.RLock()
	defer fake.loadMutex.RUnlock()
...
func (fake *Backend) LoadReturns(result1 [][]byte, result2 error) {
	fake.loadMutex.Lock()
	defer fake.loadMutex.Unlock()
	fake.LoadStub = nil
...
func (fake *Backend) LoadReturnsOnCall(i int, result1 [][]byte, result2 error) {
	fake.loadMutex.Lock()
	defer fake.loadMutex.Unlock()
	fake.LoadStub = nil
...
var _ interactive.Backend = new(Backend)
